...
<html lang="en">
	<!--begin::Head-->
	<head>
		<title>HCM OneFlux - @yield('title')</title>
		<meta charset="utf-8" />
		<meta name="description" content="HCM OneFlux 2.0 - All-in-One HCM Apps" />
		<meta name="keywords" content="hcm, oneflux, metronic, human, capital, management" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="en_US" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="HCM OneFlux 2.0 - All-in-One HCM Apps" />
		<meta property="og:url" content="{{ url('/') }}" />
		<meta property="og:site_name" content="HCM OneFlux" />
		<link rel="canonical" href="{{ url('/') }}" />
		<link rel="shortcut icon" href="{{ asset('assets/_hcm/icon-hcm-2.png') }}" />
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" class="app-default bgi-size-cover bgi-attachment-fixed bgi-position-center bgi-no-repeat">
				...
				<div id="kt_app_header" class="app-header d-flex">
					...
					<div class="app-container container-fluid d-flex align-items-center justify-content-between" id="kt_app_header_container">
						...
						<div class="app-header-logo d-flex flex-center">
							<!--begin::Logo image-->
							<a href="{{ url('/') }}">
								<img alt="Logo" src="{{ asset('_oneflux/icon-red.png')}}" class="mh-30px" />
							</a>
							<!--end::Logo image-->
